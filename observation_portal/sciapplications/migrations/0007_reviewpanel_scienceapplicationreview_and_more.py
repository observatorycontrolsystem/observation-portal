# Generated by Django 4.1.13 on 2024-06-18 23:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_submitter_status_notifications', models.BooleanField(default=False, help_text='Whether to send the application submitter notifications regarding the status of this review.')),
                ('submitter_status_notification_additional_message', models.TextField(blank=True, default='', help_text='Additional message to embed in notifications sent to the application submitter.')),
                ('can_summarize', models.ManyToManyField(help_text='Users who can edit the summary for this review', related_name='summarizeable_sciapplication_reviews', to=settings.AUTH_USER_MODEL)),
