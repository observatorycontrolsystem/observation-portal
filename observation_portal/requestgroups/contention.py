...
class Contention(object):
    ...
    def _requests(self, instrument_name):
        return Request.objects.filter(
            ...
            state='PENDING',
            configurations__instrument_class=instrument_name,
...
class Pressure(object):
    ...
    def _requests(self, instrument_name, site):
        ...
        if instrument_name:
            requests = requests.filter(configurations__instrument_class=instrument_name)
    ...
    def _binned_pressure_by_hours_from_now(self):
        ...
        for request in self.requests:
            ...
            instrument_name = request.configurations.all()[0].instrument_class
