...
from observation_portal.requestgroups.models import Request, Configuration, Target, Constraints, Location, InstrumentConfig
...
class TestCadence(SetTimeMixin, ConfigDBTestMixin, TestCase):
    def setUp(self):
        ...
        self.configuration = mixer.blend(
            Configuration, request=self.req, bin_x=2, bin_y=2, instrument_name='1M0-SCICAM-SBIG',
