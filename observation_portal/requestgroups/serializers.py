...
from observation_portal.common.telescope_states import combine_telescope_availabilities_by_site_and_class, get_telescope_availability_per_day
...
class AllTelescopeStatesSerializer(serializers.Serializer):
    data = serializers.DictField(
        child=TelescopeStateSerializer(many=True),
        source='*'
    )
